  ...
  function E(C, P) {
    ...
    try {
      ...
      if (m !== null) var qt = !0;
        ...
        var vn = t(c);
        vn !== null && yl(v, vn.startTime - P), (qt = !1);
      }
      return qt;
    } finally {
      (m = null), (p = z), (g = !1);
...
function ef(e, n, t, r, l) {
  switch (n) {
    ...
    case "pointerover":
      var i = l.pointerId;
      return jt.set(i, ft(jt.get(i) || null, e, n, t, r, l)), !0;
    case "gotpointercapture":
      return (
...
var it = {
  ...
  Pl = we(sf),
  af = A({}, it, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  cf = we(af),
  ff = A({}, it, {
...
var gf = A({}, Gt, {
  ...
  Ef = we(kf),
  Cf = A({}, it, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  _f = we(Cf),
  xf = A({}, tl, {
    deltaX: function (e) {
...
function au(e, n, t, r, l) {
  for (var i = n._reactName, o = []; t !== null && t !== r; ) {
    ...
    u.tag === 5 &&
      ...
      ((u = c),
      l
        ? ((s = Ot(t, i)), s != null && o.unshift($t(t, s, u)))
        : l || ((s = Ot(t, i)), s != null && o.push($t(t, s, u)))),
      (t = t.return);
  }
...
function po(e, n) {
  switch ((j(Bt, n), j(Vt, e), j(Ue, Jt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function Ea(e, n, t) {
  return Pn & 21
    ? (je(t, n) || ((t = Ps()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function Ci(e, n, t, r) {
  ...
  typeof i == "object" && i !== null
    ? (l.context = _e(i))
    : ((i = de(n) ? xn : le.current), (l.context = qn(e, i))),
...
function Lu(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    xr(e, n), Pa(n, t, r), Ci(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      u = n.memoizedProps;
    o.props = u;
...
function pd(e, n) {
  ...
  for (mi = { focusedElem: e, selectionRange: t }, Mr = !1, k = n; k !== null; )
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[yi], delete n[Gf], delete n[Zf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
Za = function (e, n, t) {
  ...
  else (ce = !1), F && n.flags & 1048576 && ea(n, Vr, n.index);
...
gs = xo;
ws = Ln;
var Ld = { usingClientEntryPoint: !1, Events: [Zt, Un, il, vs, ys, xo] },
  vt = {
...
const Od = "/react-cart-mobile/assets/shopping-cart-4f313a7e.png",
  jd = ({ cartCount: e }) =>
    Q.jsxs("div", {
      className: "header-top",
      children: [
        Q.jsx("div", { className: "logo" }),
        Q.jsxs("div", {
          className: "cart-icon",
          children: [
            Q.jsx("img", { src: Od, alt: "cart" }),
            e > 0 && Q.jsx("span", { className: "cart-count", children: e }),
          ],
        }),
      ],
    });
const Md = ({ product: e, isInCart: n, onToggleCart: t }) =>
    Q.jsxs("div", {
      className: "product-card",
      children: [
        Q.jsx("img", { src: e.image, alt: e.brand }),
        Q.jsx("h4", { children: e.brand }),
        Q.jsx("p", { children: e.description }),
        Q.jsxs("p", { children: [e.price.toLocaleString(), "원"] }),
        Q.jsx("button", { onClick: t, children: n ? "담김" : "담기" }),
      ],
    }),
  Hu = [
    {
...
function Dd() {
  const [e, n] = el.useState([]),
    t = (r) => {
      n((l) => (l.includes(r) ? l.filter((i) => i !== r) : [...l, r]));
    };
  return Q.jsxs("div", {
    className: "app-container",
    children: [
      Q.jsx(jd, { cartCount: e.length }),
      Q.jsxs("div", {
        className: "app-info",
        children: [
          Q.jsx("h2", { children: "신발 상품 목록" }),
          Q.jsxs("p", {
            children: ["현재 ", Hu.length, "개의 상품이 있습니다."],
          }),
        ],
      }),
      Q.jsx("div", {
...
Ql.createRoot(document.getElementById("root")).render(
  Q.jsx(wc.StrictMode, { children: Q.jsx(Dd, {}) })
);
